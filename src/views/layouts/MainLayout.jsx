...
export function MainLayout({ currentView, onViewChange, userRole, userName, onLogout, pageTitle, pageSubtitle, notifications = [], onClearNotifications, onProfileClick, onSettingsClick, canAccessSettings = false, searchNavigationOptions = [], onNavigateFromSearch, children, }) {
