...
export function ManagerDashboardView({ sims, msisdns, transactions, users, currentUserBranchId = null, stats: aggregateStats, onAddSIM, onEditSIM, onBatchImportSIM }) {
